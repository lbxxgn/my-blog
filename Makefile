...
CHECK_FILES = backend/app.py backend/config.py backend/routes/api.py backend/routes/blog/__init__.py backend/routes/admin/__init__.py backend/routes/ai/__init__.py
