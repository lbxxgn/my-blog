...
# 在生产环境中，建议显式配置 PASSKEY_RP_ID 和 PASSKEY_ALLOWED_ORIGINS
PASSKEY_RP_NAME = os.environ.get('PASSKEY_RP_NAME') or SITE_NAME
PASSKEY_RP_ID = os.environ.get('PASSKEY_RP_ID') or ''
