...
from .knowledge_base import knowledge_base_bp, quick_capture_bp
from .knowledge import knowledge_bp

__all__ = ['auth_bp', 'blog_bp', 'admin_bp', 'api_bp', 'ai_bp', 'knowledge_base_bp', 'knowledge_bp', 'quick_capture_bp']
