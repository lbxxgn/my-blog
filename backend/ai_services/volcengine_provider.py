...
"""
        ...
        try:
            ...
            logger.error(f"Volcengine summary generation error: {str(e)}")
            raise
...
"""
        ...
        try:
            ...
            logger.error(f"Volcengine recommendation error: {str(e)}")
            raise
...
"""
        ...
        try:
            ...
            logger.error(f"Volcengine continuation error: {str(e)}")
            raise
