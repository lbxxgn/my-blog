<<<<<<< Updated upstream
(function(){'use strict';let isLoading=false;let hasMore=true;let currentPage=1;let observer=null;const MOBILE_BREAKPOINT=768;const DEBUG=false;function debug(...args){if(DEBUG)console.log('[InfiniteScroll]',...args);}
...
window.InfiniteScroll={reset:function(){currentPage=1;hasMore=true;isLoading=false;},loadMore:loadMorePosts,refresh:refreshPosts,destroy:function(){if(observer){observer.disconnect();observer=null;}}};})();
=======
/**
 * 无限滚动加载
 */
